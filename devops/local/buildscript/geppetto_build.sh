...
APPLICATION='/ticketsampleapplication7824'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7824-desktop:1.0'
...
helm install --name ticketsampleapplication7824-5070 ./helm
if [ $? -eq 0 ]; then
